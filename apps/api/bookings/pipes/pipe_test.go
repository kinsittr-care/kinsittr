...
func TestCreateChangeRequest(t *testing.T) {
	...
	approvedBooking := bookingsrepo.BookingRecord{
		Booking: models.Booking{
			...
			Status:         models.ApprovedBookingStatus,
		},
	}
...
func TestAcceptChangeRequest(t *testing.T) {
	...
	request := models.BookingChangeRequest{
		...
		RequestedByRole:   models.NannyUserRole,
		Type:              models.CancelBookingChangeRequestType,
	...
	t.Run("success", func(t *testing.T) {
		...
		p := newBookingsPipe(&mockBookingsRepo{
			...
			acceptedBooking:    cancelledBooking,
			acceptedChangeReq:  acceptedRequest,
			acceptChangeReqErr: nil,
