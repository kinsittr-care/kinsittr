    ...
    <>
      ...
      >
        ...
        <div className="flex gap-[10px] items-center max-md:hidden">
          <Link href="/waitlist?role=nanny" className="btn-nav-ghost">I&apos;m a nanny</Link>
          <Link href="/waitlist?role=parent" className="btn-nav">Find a nanny</Link>
        </div>
